...
## Corpus Check
- 51 files · ~51,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 540 nodes · 879 edges · 87 communities detected
...
1. `AcpTransport` - 40 edges
2. `ServeTransport` - 29 edges
3. `isRecordLike()` - 23 edges
4. `handleMessage()` - 20 edges
5. `msAgent` - 19 edges
6. `DiagnosticsManager` - 16 edges
7. `updateHeader()` - 13 edges
8. `appendDiff()` - 13 edges
9. `MockTransport` - 12 edges
10. `extractToolCall()` - 12 edges
...
Cohesion: 0.08
Nodes (9): AcpTransport, ensureManagedServer(), getCliPath(), getServerKey(), probePort(), _resetTestDeps(), MockChildProcess, waitForServerReady() (+1 more)

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (46): add_custom(), appendDiff(), appendFinalDiff(), appendSessionResult(), appendTechnicalEntry(), appendTextStream(), appendToolCall(), appendToolResult() (+38 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (27): createFixBackend(), parseLogAtPathAndNotify(), _addFixedIndex(), clearConversationIfCancelledAndIdle(), ensureFixDetailsPanel(), fixAllDiagnostics(), fixProblem(), fixSingleDiagnostic() (+19 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (19): buildFocusedSnippet(), buildOpenCodePrompt(), buildRetryPrompt(), buildTargetedRepairHint(), buildTransportConfig(), getLine(), getOutputChannel(), collectingCallbacks() (+11 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (14): DiagnosticsManager, resolveFilePath(), classifyError(), extractInt(), extractStr(), groupLines(), isMemoryError(), parseAddressSpace() (+6 more)

### Community 5 - "Community 5"
Cohesion: 0.1
Nodes (1): ServeTransport

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (9): makeContext(), createQueueTaskId(), bodyOf(), MockClientRequest, MockIncomingMessage, MockWritable, respondWithJson(), SessionStateMachine (+1 more)
...
Cohesion: 0.09
Nodes (10): CancellationTokenSource, CodeAction, Diagnostic, DiagnosticCollection, DiagnosticRelatedInformation, EventEmitter, Location, Position (+2 more)
...
- **Thin community `Community 21`** (2 nodes): `makeReader()`, `config.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (2 nodes): `makeDiag()`, `diagnosticsManager.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (2 nodes): `makeDiag()`, `fixService.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `Agent Loop`, `Rationale: Loop until done design`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `FixBackend Interface`, `Rationale: Backend-agnostic UI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `msagent.modelName`, `qwen3:8b`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (2 nodes): `AGENTS.md`, `CLAUDE.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 30`** (2 nodes): `Skill Loading`, `Rationale: On-demand Skills design`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `setup.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (1 nodes): `types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `opencodeModelCatalog.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `openCodeFixBackend.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `fixBackend.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `backendFactory.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `opencodeEventAdapter.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `messages.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `fixDetailsScript.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `sessionState.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `fixDetailsScript.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `webviewPanelProvider.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `sessionEvents.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `sessionStateMachine.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `logParser.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `skillLoader.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `skills/memcheck-skills.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `Streaming WebView`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `CodeAction Quick Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `Diagnostics Manager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `Fix Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `LLM Provider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Cancellation Token`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Progress Notification`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `Content Security Policy (CSP)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `Diff Rendering`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `Transport Layer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `OpenCodeSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Event Adapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Message Replay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `Queue State Management`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `msagent.temperature`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `msagent.maxTokens`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `msagent.timeoutMs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `msagent.provider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `msagent.opencodeMode`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `msagent.opencodeCliPath`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `msagent.opencodeServePort`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `msagent.opencodeApiEndpoint`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `msagent.opencodeApiKey`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `T2: LLM Communication Test`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `T3: LLM Tool Call Generation Test`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `T4: Agent Loop Test (Mock LLM)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `T5: Full E2E Fix Test`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `T6: Error Recovery Test`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `vLLM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `llama.cpp server`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `xinference`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `qwen3-coder:30b`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `qwen2.5:3b`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `deepseek-coder:6.7b`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `Rationale: Error Recovery design`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `Rationale: Message History Management`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (1 nodes): `Rationale: WebView Rendering optimization`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `Rationale: LLM Streaming UX`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `AcpTransport` connect `Community 0` to `Community 5`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `ServeTransport` connect `Community 5` to `Community 0`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `loadFixture()` connect `Community 12` to `Community 3`, `Community 7`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
